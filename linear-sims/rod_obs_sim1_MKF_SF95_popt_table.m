...
sim_name = "rod_obs_sim1_MKF_SF95_popt";
...
id_cols = {'t_stop', 'Ts', 'nT', 'nu', 'ny', 'n', ...
    ...
    'MKF_SF95_R', 'MKF_SF95_Q0_1_1', 'MKF_SF95_Q0_2_2' ...
};
...
sigma_M = results_table.sigma_M(1);
...
selected_cols = { ...
    'MKF_SF95_nf', 'MKF_SF95_f', 'MKF_SF95_m', 'MKF_SF95_d', ...
    'MKF_SF95_nh', 'MKF_SF95_beta', ...
    ... 'RMSE_x_est_1_MKF_SF95', 'RMSE_x_est_2_MKF_SF95', ...
    'RMSE_y_est_MKF_SF95'};

rows = (results_table.MKF_SF95_d >= d_min) & (results_table.seed == seed);
...
n_rows = 10;
col_labels = {'$n_f$', '$n_m$', '$n_d$', '$n_h$', '$\beta$', ...
...
disp("\hline")
fprintf("%% See script rod_obs_sim1_MKF_SF95_popt_table.m\n")
