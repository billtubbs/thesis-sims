...
sim_name = "rod_obs_sim3_MKF_SF_popt";
...
selected_cols = [{
        char(obs_label + '_nf'), char(obs_label + '_f'), ...
        char(obs_label + '_m'), char(obs_label + '_d'), ...
        char(obs_label + '_beta'), char(obs_label + '_nh'), ...
    } ...
    RMSE_labels];
...
rows = ( ...
    (results_table.MKF_SF1_d >= d_min) & ...
    (results_table.seed == seed) & ...
    (results_table.MKF_SF1_nh <= nh_max) ...
);
...
disp("\hline")
fprintf("%% See script rod_obs_sim3_MKF_SF98_popt_table.m\n")
