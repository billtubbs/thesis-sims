...
% first-order process with a RODD step and a RODD ramp 
% disturbance at the input to the process.
% 
...
% PhiD = [1 -0.5];
% d = 1;
% HDd_exp = rodd_tf(ThetaD, PhiD, d, Ts);

% RODD step + ramp disturbance process
HDd = [HDd_step HDd_ramp];
