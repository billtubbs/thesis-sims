...
classdef MKFObserverSF_RODD < MKFObserverSF_DI
    ...
    methods
        function obj = MKFObserverSF_RODD(model,io,P0,epsilon, ...
                sigma_wp,Q0,R,nf,m,d,label,x0,r0)
            arguments
                model struct
                io struct
                ...
                Q0 (:, :) double
                R (:, :) double
                nf (1, 1) double {mustBeInteger, mustBeGreaterThan(nf, 0)}
            ...
            idx_switch = 1:nw;
            var_wp = cell2mat(sigma_wp(idx_switch)').^2;
            var_wp(:, 2) = var_wp(:, 2) ./ d;
            ...
            [Q, p_rk, seq, p_seq] = construct_Q_model_SF(Q0, model.B, ...
                io.u_known, alpha, var_wp, nf, m, nw);
            ...
            obj = obj@MKFObserverSF_DI(models,P0,seq,T,d,label,x0,r0, ...
                [],false)
